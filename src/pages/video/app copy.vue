<template>
  <div id="app" :class="{'WhitePage': ShowError}">
    <MainPage ref="MainPage" @UserInfoChange="UserInfoChange" @NetSpeedTestEnd="NetSpeedTestEnd" :Show="!IsFullWindow">
      <div class="PlayPageContainer" style="width: calc(100% - 200px); min-width: 1000px; margin: 0 auto; padding-bottom: 30px; padding-top: 69px; position: relative; overflow: visible;" ref="PlayPageContainer" v-if="MediaInfo !== null && MediaInfo.video !== null && !ShowError">
        ...
        <div class="PlayerContainer flex-h">
          <div class="flex-item">
            ...
            <div class="BottomInfo flex-h">
              ...
              <a :class="{'active': HasCollected}" @click="ToCollectVideo" class="Collect"><i class="iconfont iconshoucang-"></i><span>{{CollectNum}}</span></a>
