<template>
  <div id="app" class="WhitePage">
    <MainPage :HideFooter="true">
      <div class="Text">
        <pre>
          This Privacy Notice for California Residents supplements the information contained in Hey Industry Limited’s Privacy Policy and applies solely to all visitors, users, and others who reside in the State of California. We adopted this notice to comply with the California Consumer Privacy Act of 2018 (CCPA) and any terms defined in the CCPA have the same meaning when used in this notice.
          ...
          <img src="../../assets/img/ppa-text1.png" alt="">

          <img src="../../assets/img/ppa-text2.png" alt="">
          ...
          b. To process your requests, purchases, transactions, and payments and prevent transactional fraud.
          c. To provide you with support and to respond to your inquiries, including to investigate and address your concerns and monitor and improve our responses.
          d. To respond to law enforcement requests and as required by applicable law, court order, or governmental regulations.
          e. As described to you when collecting your personal information or as otherwise set forth in the CCPA.
          f. To evaluate or conduct a merger, divestiture, restructuring, reorganization, dissolution, or other sale or transfer of some or all of our or our affiliates’ assets in which personal information held by us or our affiliates about our website users is among the assets transferred.
          g. We will not collect additional categories of personal information or use the personal information we collect for materially different, unrelated, or incompatible purposes without providing you notice.
          ...
          To exercise the access, data portability, and deletion rights described above, please submit a verifiable consumer request to us by either:
                  Emailing us at <a href="mailto:contactus@heyporn.com">contactus@heyporn.com</a>
          Only you, or a person registered with the California Secretary of State that you authorize to act on your behalf, may make a verifiable consumer request related to your personal information. You may also make a verifiable consumer request on behalf of your minor child.
          • You may only make a verifiable consumer request for access or data portability twice within a 12-month period. The verifiable consumer request must:
          • Provide enough information that allows us to reasonably verify you are the person about whom we’ve collected personal information or an authorized representative.
          ...
          California’s “Shine the Light” law (Civil Code Section § 1798.83) permits users of our website that are California residents to request certain information regarding our disclosure of personal information to third parties for their direct marketing purposes. To make such a request, please send an email to <a href="mailto:contactus@heyporn.com">contactus@heyporn.com</a>
          ...
          <a href="mailto:contactus@heyporn.com">contactus@heyporn.com</a>
        </pre>
      </div>
    </MainPage>
  </div>
