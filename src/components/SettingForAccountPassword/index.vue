  ...
  <div class="components SettingForAccountPassword SettingFormInput">
    <div class="Form" v-if="Step === 1">
      ...
      <div class="Line">
        ...
        <div>
          <input type="text" placeholder="Add verification code">
        </div>
      </div>
    </div>
    <div class="Bottom flex-h" v-if="Step === 1">
      <span class="flex-item">E-mail 235525@qq.com is verified</span>
    ...
    <div class="Form" v-if="Step === 2">
      ...
      <div class="Line">
        ...
        <div>
          <input type="text" placeholder="Add new password">
        </div>
      </div>
      <div class="Line">
        <span>Confirm new password</span>
        <div>
          <input type="text" placeholder="Add new password again">
        </div>
      </div>
    </div>
