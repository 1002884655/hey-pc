<template>
  <div class="components ImageCropping" ref="ImageCropping">
    <div class="centerLabel">
      ...
      <div class="Content flex-h">
        <div class="flex-item">
          <div class="CanvasArea">
            <div v-if="FileImageUrl !== null">
              <vue-cropper ref="Cropper" autoCrop :img="FileImageUrl" centerBox fixed :fixedNumber="[1,1]" />
            </div>
          </div>
        ...
        <div class="PreviewArea">
          <div class="Icon">
            <div>
              <a><img :src="OriginalBase" class="centerLabel cover" alt=""></a>
            </div>
            <span>108 * 108</span>
          </div>
          <div class="Icon">
    ...
    CreateScreenshot () { // 生成截图
      if (!this.DataLock) {
        ...
        this.$refs.Cropper.getCropData(data => {
          ...
          Img.style.opacity = '0'
          this.$refs.ImageCropping.appendChild(Img)
          this.DataLock = false
        })
      }
    },
